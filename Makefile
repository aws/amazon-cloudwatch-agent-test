...
LINUX_AMD64_BUILD = GOOS=linux GOARCH=amd64 go build -trimpath -o $(BUILD_SPACE)/validator/linux/amd64
LINUX_ARM64_BUILD = GOOS=linux GOARCH=arm64 go build -trimpath -o $(BUILD_SPACE)/validator/linux/arm64
