...
$step=0
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a remove-config -c all -m onPremise
...
$step=2
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a start -m onPremise
assertAgentsStatus -CWAgentRunningExpectedStatus "running" `
                        -CWAgentConfiguredExpectedStatus "configured"

$step=3
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a remove-config -c default -s -m onPremise
assertAgentsStatus -CWAgentRunningExpectedStatus "running" `
                        -CWAgentConfiguredExpectedStatus "configured"

$step=4
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a prep-restart -m onPremise
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a stop
assertAgentsStatus -CWAgentRunningExpectedStatus "stopped" `
                        -CWAgentConfiguredExpectedStatus "configured"

$step=5
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a cond-restart -m onPremise
assertAgentsStatus -CWAgentRunningExpectedStatus "running"  `
                        -CWAgentConfiguredExpectedStatus "configured"

$step=6
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a append-config -c default -s -m onPremise
assertAgentsStatus -CWAgentRunningExpectedStatus "running" `
                        -CWAgentConfiguredExpectedStatus "configured"
...
$step=8
& "C:\Program Files\Amazon\AmazonCloudWatchAgent\amazon-cloudwatch-agent-ctl.ps1" -a fetch-config -s -m onPremise
assertAgentsStatus -CWAgentRunningExpectedStatus "running" `
                        -CWAgentConfiguredExpectedStatus "configured"
