...
# init
step=0
/usr/bin/amazon-cloudwatch-agent-ctl -a remove-config -c all -m onPremise
...
step=2
/usr/bin/amazon-cloudwatch-agent-ctl -a start -m onPremise
assertStatus "cwa_running_status" "running"
assertStatus "cwa_config_status" "configured"

step=3
/usr/bin/amazon-cloudwatch-agent-ctl -a remove-config -c default -s -m onPremise
assertStatus "cwa_running_status" "running"
assertStatus "cwa_config_status" "configured"

step=4
/usr/bin/amazon-cloudwatch-agent-ctl -a prep-restart -m onPremise
/usr/bin/amazon-cloudwatch-agent-ctl -a stop
assertStatus "cwa_running_status" "stopped"
assertStatus "cwa_config_status" "configured"

step=5
/usr/bin/amazon-cloudwatch-agent-ctl -a cond-restart -m onPremise
assertStatus "cwa_running_status" "running"
assertStatus "cwa_config_status" "configured"

step=6
/usr/bin/amazon-cloudwatch-agent-ctl -a append-config -c default -s -m onPremise
assertStatus "cwa_running_status" "running"
assertStatus "cwa_config_status" "configured"
...
step=8
/usr/bin/amazon-cloudwatch-agent-ctl -a fetch-config -s -m onPremise
assertStatus "cwa_running_status" "running"
assertStatus "cwa_config_status" "configured"
