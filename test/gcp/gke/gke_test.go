...
var (
	...
	// payloadPrefix is the lowercase compute type: the prefix the load generator template was
	// rendered with, so validation greps for exactly what generation emitted.
