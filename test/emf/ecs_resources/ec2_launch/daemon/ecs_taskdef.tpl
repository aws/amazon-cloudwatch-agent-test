[
    ...
    },
    {
        ...
        "image": "506463145083.dkr.ecr.us-west-2.amazonaws.com/v2/cwagent-integration-test/manifests/ubuntu-socat-2.0.0-2",
        "logConfiguration": {
            "logDriver": "awslogs",
            "options": {
                "awslogs-region": "${region}",
