...
func (f *NetStatMetricValueFetcher) isApplicable(metricName string) bool {
	netstatSupportedMetric := f.getPluginSupportedMetric()
	_, exists := netstatSupportedMetric[metricName]
	return exists
}
