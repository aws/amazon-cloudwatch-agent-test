...
resource "null_resource" "integration_test_run" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "git clone git@github.com:Paramadon/amazon-cloudwatch-agent-sepolicy.git",
      ...
      "echo this is after LOCAL_STACK_HOST_NAME",
      "export AWS_REGION=${var.region}",
      "echo this is after aws region",
      "export PATH=$PATH:/snap/bin:/usr/local/go/bin",
      "echo this is after Path",
